...
data class Country(
    ...
    val leftHandTraffic: Boolean = false
)

enum class SafetyLevel(@param:StringRes val displayNameResId: Int, val color: Color) {
...
enum class VisaRequirement(@param:StringRes val displayNameResId: Int, val color: Color) {
...
enum class Continent(@param:StringRes val displayNameResId: Int) {
