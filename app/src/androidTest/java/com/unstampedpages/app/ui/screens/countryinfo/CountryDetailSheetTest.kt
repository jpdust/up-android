...
class CountryDetailSheetTest {
    ...
    fun currencySymbol_gbp_showsPoundSign() {
        ...
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("£")
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("British Pound (GBP)")
    }
    ...
    fun currencySymbol_eur_showsEuroSign() {
        ...
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("€")
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("Euro (EUR)")
    }
    ...
    fun currencySymbol_jpy_showsYenSign() {
        ...
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("¥")
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("Japanese Yen (JPY)")
    }
    ...
    fun currencySymbol_usd_showsDollarSign() {
        launchSheet(country(currencyCode = "USD", currency = CURRENCY_US_DOLLAR, exchangeRateToUSD = 1.0))
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("$")
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("US Dollar (USD)")
    }
    ...
    fun currencySymbol_inr_showsRupeeSign() {
        ...
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("₹")
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("Indian Rupee (INR)")
    }
    ...
    fun currencySymbol_krw_showsWonSign() {
        ...
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("₩")
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("South Korean Won (KRW)")
    }

    @Test
    fun currencySymbol_brl_showsRealSign() {
        launchSheet(country(currencyCode = "BRL", currency = "Brazilian Real", exchangeRateToUSD = 0.20))
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("R$")
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("Brazilian Real (BRL)")
    }
    ...
    fun currencySymbol_try_showsTurkishLiraSign() {
        ...
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("₺")
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("Turkish Lira (TRY)")
    }
    ...
    fun currencySymbol_unknown_fallbackToDollarSign() {
        ...
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("$")
        composeTestRule.onNodeWithTag("info_currency").assertTextContains("Unknown Currency (XYZ)")
    }
